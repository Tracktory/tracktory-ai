...
_NAV_ITEMS: frozenset[str] = frozenset({
    "로그인", "종합정보시스템", "한성대 바로가기", "전체메뉴", "홈으로",
    "메인화면", "인쇄", "공유", "즐겨찾기",
    "트랙소개", "전공소개", "학과소개",
    "교수소개", "교육과정소개", "교과목로드맵", "비교과프로그램", "트랙졸업요건",
    "게시판", "트랙홍보영상", "전공홍보영상", "전공 홍보영상",
    "대학소개", "학사안내", "정보마당", "입학안내", "입학 안내",
    "사이트맵", "Q&A", "교수 소개", "비교과 프로그램",
    "트랙 홈페이지", "홈페이지 바로가기", "홈페이지바로가기", "홈페이지 바로 가기",
    "글로벌인재대학 상세학과 닫기", "미래플러스대학 상세학과 닫기",
    "상상력교양대학 상세학과 닫기",
    "산학 및 졸업생 멘토풀 현황", "산학 및 졸업생 멘토 풀 현황", "산학 멘토 풀 현황",
    "위치", "전화", "팩스",
})

_FOOTER_EXACT: frozenset[str] = frozenset({
    "개인정보처리방침", "이메일무단수집거부", "이메일주소무단수집거부",
    "교내주요사이트", "관련기관",
    "학내 주요 서비스", "대외 협력·연계", "발전기금",
    "TOP",
})
...
def clean(raw_text: str, track_name: str) -> list[str]:
    """Raw 텍스트에서 웹 UI 노이즈를 제거한 줄 리스트를 반환한다."""

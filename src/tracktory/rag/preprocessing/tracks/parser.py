...
_SECTION_HEADERS: dict[str, frozenset[str]] = {
    "소개": frozenset({
        "트랙 소개", "트랙소개", "전공 소개", "전공소개",
        "학과소개", "학과 소개", "학부소개", "학부 소개",
    }),
    "교육목표": frozenset({
        "교육목표", "교육 목표",
        "학과 교육목표", "학과교육목표",
...
def _classify(line: str) -> str | None:
    ...
    if line.endswith(" 소개") and len(line) < 20 and any(w in line for w in ("학부", "학과", "전공", "트랙")):
        return "소개"
